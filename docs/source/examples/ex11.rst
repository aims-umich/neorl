...
where :math:`\rho_{tgt}` is the target reactivity. The :math:`c` subscript is used to show that this objective dunction corresponds to the criticality conditions of the core.
