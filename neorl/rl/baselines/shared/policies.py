...
from neorl.rl.baselines.shared.distributions import make_proba_dist_type, CategoricalProbabilityDistribution, \
    MultiCategoricalProbabilityDistribution, DiagGaussianProbabilityDistribution, BernoulliProbabilityDistribution
from neorl.rl.baselines.shared.input import observation_input
...
def mlp_extractor(flat_observations, net_arch, act_fun):
    ...
    for idx, layer in enumerate(net_arch):
        # CHANGE: added following print statements
        print('Adding SHARED layer number --', idx, '-- with ', layer, 'nodes')
    ...
    for idx, (pi_layer_size, vf_layer_size) in enumerate(zip_longest(policy_only_layers, value_only_layers)):
        # CHANGE: added following print statements
        print('Adding NON-SHARED layer number --', idx, '-- with ', layer, 'nodes')
